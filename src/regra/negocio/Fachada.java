...
//
//	public static Pessoa criarPessoa(String nome, String dtnascimento, String cpf, String funcao, Double cache)
//			throws Exception {
//		nome = nome.trim();
//		dtnascimento = dtnascimento.trim();
//		cpf = cpf.trim();
//		funcao = funcao.trim();
//		DAO.begin();
...
//		cnpj = cnpj.trim();
//		DAO.begin();
//		Estudio estudio = daoEstudio.readByNome(nome);
//		if (estudio != null) {
//			DAO.rollback();
...
//	}
//
//	public static Filme criarFilme(String nome, String dtLancamento) throws Exception {
//		nome = nome.trim();
//		dtLancamento = dtLancamento.trim();
//		DAO.begin();
//		Filme filme = daoFilme.readByNome(nome);
//		if (filme != null) {
//			DAO.rollback();
...
//		}
//		filme = new Filme(nome, dtLancamento);
...
//	}
//
//	public static void addEstudioAoFilme(String nomeEstudio, String nomeFilme) throws Exception {
//		nomeEstudio = nomeEstudio.trim();
//		nomeFilme = nomeFilme.trim();
//
//		DAO.begin();
//		Estudio estudio = daoEstudio.readByNome(nomeEstudio);
//		if (estudio == null) {
//			DAO.rollback();
//			throw new Exception("Não adicionou estúdio" + nomeEstudio + " inexistente");
//		}
//		Filme filme = daoFilme.readByNome(nomeFilme);
//		if (filme == null) {
//			DAO.rollback();
//			throw new Exception("Não adicionou estúdio" + nomeEstudio + " ao filme, " + nomeFilme + " inexistente");
//		}
...
//	}
//
//	public static void apagarFilmePorId(int id) throws Exception {
...
//	}
//	
//	public static List<Pessoa> atrizDiretoraTrabalhamEmUmEstudio(String nomeEstudio, String funcao)throws Exception{
//		Estudio estudio = daoEstudio.readByNome(nomeEstudio);
//		if(estudio == null) {
//			DAO.rollback();
//			throw new Exception("Este Estúdio não existe");
//		}
//		List<Pessoa> pessoas = daoPessoa.atrizDiretoraTrabalhamEmUmEstudio(nomeEstudio, funcao);
//		if(pessoas.isEmpty()) {
//			DAO.rollback();
